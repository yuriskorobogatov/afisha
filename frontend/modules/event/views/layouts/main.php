...
use frontend\assets\AppAsset; //where to get assets for module
				...
				<div class="right-side">
					...
					<div class="header-widget hide-on-mobile">
						...
						<div class="header-notifications">
							...
							<!-- Trigger -->
							<div class="header-notifications-trigger">
								<a href="#"><i class="icon-feather-heart"></i><span><?= \Yii::$app->session['model']->messages ?></span></a>
							</div>
						...
						<div class="header-notifications">
							<div class="header-notifications-trigger">
								<a href="#"><i class="icon-feather-mail"></i><span><?= \Yii::$app->session['model']->messages ?></span></a>
							</div>
							...
							<div class="header-notifications-dropdown">
								...
								<div class="user-status">
									...
									<div class="user-details">
										...
										<div class="user-name">
											<?= \Yii::$app->session['model']->name ?> 
											<span><?= \Yii::$app->session['model']->state ?></span>
										</div>
									</div>
								...
								<ul class="user-menu-small-nav">
									...
									<li><a href="dashboard.html"><i class="icon-line-awesome-bold"></i> Баллы  <span class="nav-tag" style="color:limegreen"><?= \Yii::$app->session['model']->points ?></span></a></li>
